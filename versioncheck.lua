...
updatePath = "/MurilloGavron/Assets" -- your git user/repo path
...
function checkVersion(err,responseText, headers)
	...
	elseif tonumber(curVersion) > tonumber(responseText) then
		print("You somehow skipped a few versions of "..resourceName.." or the git wentddddd offline, if it's still online i advise you to update ( or downgrade? )")
	else
